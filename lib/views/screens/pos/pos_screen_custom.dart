...
class PosScreenCustom extends StatefulWidget {
  PosScreenCustom({super.key, required this.tableId, required this.userID});
  String? tableId;
  final String? userID;
...
class _POSScreenState extends State<PosScreenCustom> {
